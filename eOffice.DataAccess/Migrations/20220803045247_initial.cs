        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OfficeSection = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    From = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LetterNo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LetterDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateReceived = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CoveringLetter = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Enclosure1 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Enclosure2 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Enclosure3 = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ApplicationUserName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DraftLetterUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DateTimeUpload = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
