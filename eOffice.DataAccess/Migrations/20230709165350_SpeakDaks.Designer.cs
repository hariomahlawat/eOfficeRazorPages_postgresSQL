...
namespace eOffice.DataAccess.Migrations
{
    ...
    [Migration("20230709165350_SpeakDaks")]
    partial class SpeakDaks
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("eOffice.Models.DakSpeak", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("eOffice.Models.DakSpeak", b =>
                {
                    ...
                    b.HasOne("eOffice.Models.ApplicationUser", "MarkedBy")
                        .WithMany()
                        .HasForeignKey("MarkedById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("eOffice.Models.ApplicationUser", "MarkedFor")
                        .WithMany()
                        .HasForeignKey("MarkedForId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
